...
const maxNumberOfRecovery = Number(process.env.MAXNUMBEROFRECOVERY) || 10;
const deleteCollectionBatchSize = Number(process.env.DELETECOLLECTIONBATCHSIZE) || 100;
const deleteCollectionPath = process.env.DELETECOLLECTIONPATH || 'execution';
const RECOVERY = 2;
const contract = {
