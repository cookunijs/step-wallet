...
module.exports = functions.https.onCall((data, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (count >= walletClient_1.default.maxNumberOfExecution) {
    ...
    if (cosigner === cosignerSenderPubKey) {
        ...
        const sendData = yield walletClient_1.default.sendSignedTransaction(cosigner, wallet, encodeABI);
        count += 1;
        yield docRefExecution.update({
            count: count,
        });
        return sendData;
    }
